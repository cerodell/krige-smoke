...
class Channel:
    ...
    def setup(self) -> None:
        ...
        self.current_pm1_0_cf_1: Optional[float] = self.safe_float("pm1_0_cf_1")
        self.current_pm2_5_cf_1: Optional[float] = self.safe_float("pm2_5_cf_1")
        self.current_pm10_0_cf_1: Optional[float] = self.safe_float("pm10_0_cf_1")
        ...
        self.current_pm10_0_atm: Optional[float] = self.safe_float("pm10_0_atm")
    ...
    def get_historical(
        ...
        # pylint: disable=line-too-long
        channel = (
            self.tp_primary_channel
            if thingspeak_field == "primary"
            else self.tp_secondary_channel
        )
        key = (
            self.tp_primary_key
            if thingspeak_field == "primary"
            else self.tp_secondary_key
        )
        ...
        parent_cols = (
            PARENT_PRIMARY_COLS
            if thingspeak_field == "primary"
            else PARENT_SECONDARY_COLS
        )
        # pylint: disable=line-too-long
        child_cols = (
            CHILD_PRIMARY_COLS
            if thingspeak_field == "primary"
            else CHILD_SECONDARY_COLS
        )
